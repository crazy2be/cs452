...
The prorities chosen for the clock server, IO servers, and name servers have been
...
The remaining priorities are rougly chosen to prioritize a response to inbound events from
the outside world.
